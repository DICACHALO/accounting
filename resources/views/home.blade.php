    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="card">
                ...
                <a href="{{ route('report') }}" style="text-decoration:none;color:black;" class="btn btn-light btn-block"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
