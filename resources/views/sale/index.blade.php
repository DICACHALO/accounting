                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                <strong>{{ __('Tirillas de venta') }}</strong>
                                &nbsp &nbsp &nbsp
                                ...
                                <tbody>
                                    @foreach ($sales as $sale)
                                        <tr>                                           
                                            ...
                                            <td>
                                                <form action="{{ route('sales.destroy',$sale->id) }}" method="POST" id="myForm">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('sales.show',$sale->id) }}"><i class="fa fa-fw fa-eye"></i>Ver detalles</a>&nbsp
                                                    <a class="btn btn-sm btn-success" href="{{ route('sales.edit',$sale->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>&nbsp &nbsp &nbsp
